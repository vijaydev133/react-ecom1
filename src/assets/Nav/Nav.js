...
//                   <Typography textAlign="center" onClick={()=>handlePage(page)} >{page}  </Typography>
//                 </MenuItem>
//               ))}
//             </Menu>
//           </Box>
      ...
      <AppBar sx = {{background: "#063970"}}>
        <Toolbar>
            ...
            <Tabs textColor = {"inherit"} value={0}>
              ...
              <Tab label = "Cart" onClick={()=>navigate("/cart")}></Tab>
              <Tab label = "Fav" onClick={()=>navigate("/fav")}></Tab>
            </Tabs>
